    ...
    <>
      <header className="flex items-center h-20 px-6 sm:px-10 bg-white">
        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          ...
          onClick={ () => {
            let element = document.getElementById("profileOption");
          ...
          <div className="border-l pl-3 ml-3 space-x-1">
            <button
              ...
              onClick={() => {
                let element = document.getElementById("dropdownNotification");
                element.classList.toggle("hidden");
              }}
            >
          ...
          {/* Profile Drop Down */}
            ...
            <div
            id="profileOption"
              className="hidden absolute top-16 right-36 z-20 w-48 py-2 mt-2 bg-white rounded-md shadow-xl dark:bg-gray-800"
            >
              <Link
                /* href={`/public/profile/${userName}`} */
                href={`/public/profile/${data.userName}`}
              ...
              >
                ...
                <span className="mx-1">Friends</span>
              </Link>
              ...
              >
                ...
                <span className="mx-1">Invite Friends</span>
              </Link>
              ...
              >
                ...
                <span className="mx-1">Help & Support</span>
              </Link>
              <Link
                href="#"
                className="flex items-center p-3 text-sm text-gray-600 capitalize transition-colors duration-300 transform dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"
          ...
          <div className="absolute top-20 right-8">
            <div
              ...
              className="hidden z-0 w-full max-w-sm bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-800 dark:divide-gray-700"
